...
export async function sendWelcomeSMS(phone, tag) {
  ...
  const message = `Welcome to The Royce Hotel. Your valet tag is #${tag} — we'll take care of the rest.When you're ready for your vehicle, request it here: ${guestLink}`;
